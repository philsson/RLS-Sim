...
if plot_z_axis
    ...
    length3 = length(xLength);
        ...
        if get_easy_files
           saveas(gcf,'Results\3EVOManualtuningZ','epsc');
        end
        ...
        if get_easy_files
           saveas(gcf,'Results\3EVOManualtuning_errorsZ','epsc');
        end
        ...
        if get_easy_files
           saveas(gcf,'Results\3EVOManualtuning_inertiaZ','epsc');
        end
...
if plot_x_axis
    ...
    length3 = length(xLength);
        ...
        figure('Name', 'X-axis Evalution 3') %, 'Position', [110, 800, 1290,320]); clf;
        subplot(3,1,1); hold all; grid on;
        plot(xLength, log(1).r,'--', 'LineWidth',lineSize + 0.5, 'Color', Ref);
        plot(xLength, log(2).y, 'LineWidth',lineSize, 'Color', Manual)
        plot(xLength, log(1).y, 'LineWidth',lineSize,'Color', Evo)
        ...
        if get_easy_files
           saveas(gcf,'Results\3EVOManualtuningX','epsc');
        end
        ...
        if get_easy_files
           saveas(gcf,'Results\3EVOManualtuning_errorsX','epsc');
        end
        ...
        if get_easy_files
           saveas(gcf,'Results\3EVOManualtuning_inertiaX','epsc');
        end
