...
SIM_samples = 3000;                  % Hur m??nga iterationer simuleringen k??r
...
apply_evo           =  [ 1 1 1 ];    % Till??mpar tuning reglerna under realtid
...
battery_reduction = 0.5; % How much will we discharge the battery
